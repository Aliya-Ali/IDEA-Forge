...
<div class="container-fluid bg-dark text-white py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <p><i class="fa fa-map-marker-alt mr-2"></i>Pakistan</p>
                <p><i class="fa fa-phone-alt mr-2"></i>+92 336 2042142</p>
                <p><i class="fa fa-envelope mr-2"></i>fahadahmedaz3@gmail.com</p>
    ...
    <!-- Back to Top -->
    <a href="<?php echo site_url(); ?>" class="btn btn-lg btn-primary back-to-top"><i class="fa fa-angle-double-up"></i></a>
    </body>
